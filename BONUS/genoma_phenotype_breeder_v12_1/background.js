...
function installChildPhenotype(child, mode) {
  ...
  Object.assign(host.style, { position:'fixed', inset:'0', zIndex:'2147483600', display:'none', pointerEvents:'auto', background:'rgba(255,255,255,.985)' });
  ...
  shadow.innerHTML = `<style>
    ...
    ${safe.css}
  </style><div class="frame"><div class="genoma-bar"><span>GENOMA CHILD PHENOTYPE · LIVE</span><span>${escapeHTML(safe.title)}</span></div><div class="diff-panel"><b>DIFF MODE:</b> F0 remains underneath/alongside. This child is a reversible sibling layer. ${escapeHTML(safe.diffSummary)}</div><div class="child"><span class="proof">CHILD LAYER INSTALLED ON THIS PAGE · ORIGINAL IS PRESERVED BELOW/BEHIND</span>${safe.html}</div></div>`;
